        ...
        <div className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl border border-[#dde2dc] bg-[#ffffff] p-4 shadow-[0_8px_20px_rgba(35,28,20,0.05)]">
                    ...
                    <div className="sf-serif text-[26px] font-semibold tracking-[0.01em] text-[#2a3330]">{summary ? formatCny(summary.totalRevenueCents) : "—"}</div>
                </div>
                <div className="rounded-2xl border border-[#dde2dc] bg-[#ffffff] p-4 shadow-[0_8px_20px_rgba(35,28,20,0.05)]">
                    <div className="mb-2.5 flex items-center gap-1.5 font-mono text-[11px] font-semibold uppercase tracking-[0.14em] text-[#67726b]">
                    ...
                    <div className="sf-serif text-[26px] font-semibold tracking-[0.01em] text-[#2a3330]">{summary ? formatCny(summary.totalCostCents) : "—"}</div>
                    <div className="mt-1 text-[11px] text-[#9aa49e]">按 GenerationJob.costCents 公开价粗估</div>
                </div>
                <div className="rounded-2xl border border-[#dde2dc] bg-[#ffffff] p-4 shadow-[0_8px_20px_rgba(35,28,20,0.05)]">
                    <div className="mb-2.5 flex items-center gap-1.5 font-mono text-[11px] font-semibold uppercase tracking-[0.14em] text-[#67726b]">
                ...
                <div className="rounded-2xl border border-[#dde2dc] bg-[#ffffff] p-4 shadow-[0_8px_20px_rgba(35,28,20,0.05)]">
                    ...
                    <div className="sf-serif text-[26px] font-semibold tracking-[0.01em] text-[#2a3330]">{summary ? formatPercent(summary.marginRate) : "—"}</div>
                </div>
            </div>
