...
export function ShotPackNodeContent({ node }: { node: CanvasNodeData }) {
    ...
    if (node.metadata?.content) {
        return (
            <div className="relative h-full w-full overflow-hidden rounded-3xl bg-[#f9f7f5]">
    ...
    return (
        <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-[#f9f7f5] text-[#77716b]">
            <div className="flex size-16 items-center justify-center rounded-2xl bg-white shadow-sm">
                <Images className="size-7 text-[#a0713f]" />
            </div>
            <div className="text-center">
                <div className="text-sm font-semibold text-[#1b1814]">镜头包</div>
