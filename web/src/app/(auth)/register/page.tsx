                ...
                <div className="space-y-4">
                    {step === 1 && (
                        <>
                            ...
                            <Button type="primary" size="large" block loading={loading} onClick={handleSendCode} className="!rounded-xl !h-11 !font-medium">
                                发送验证码
                            </Button>
                        </>
                    )}
                    ...
                    {step === 2 && (
                        <>
                            ...
                            <Button type="primary" size="large" block loading={loading} onClick={handleVerifyCode} className="!rounded-xl !h-11 !font-medium">
                                验证
                            </Button>
                    ...
                    {step === 3 && (
                        <>
                            ...
                            <Button type="primary" size="large" block loading={loading} onClick={handleRegister} className="!rounded-xl !h-11 !font-medium">
                                注册
                            </Button>
                        </>
                    )}
