...
export async function GET(req: NextRequest) {
    try {
        ...
        const [modelConfigs, operationConfigs] = await Promise.all([prisma.modelConfig.findMany({ orderBy: [{ type: "asc" }, { provider: "asc" }, { displayName: "asc" }] }), prisma.operationConfig.findMany({ orderBy: { key: "asc" } })]);
